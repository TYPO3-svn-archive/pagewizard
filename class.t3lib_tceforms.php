...
class t3lib_TCEforms	{
	...
	var $commentMessages=array();				// An accumulation of messages from the class.
		...
		// INTERNAL, templates
	var $totalWrap='';				// Total wrapping for the table rows.
	var $fieldTemplate='<label style="display:block;font-weight:bold">###FIELD_NAME###</label><br />###FIELD_ITEM###<br /><br />';	// Field template
	...
	function t3lib_TCEforms()	{
		global $CLIENT, $TYPO3_CONF_VARS,$BACK_PATH;
